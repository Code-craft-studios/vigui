...
const SocialMedia = ({ customSocial =  defaultSocial }: SocialProp) => {
  return (
    <>
      <Typography pb={3} component='p' textAlign={'center'} display={{xs: 'none', md: 'block'}}>Redes sociales</Typography>
      <Grid container columns={4}>
        {customSocial.map((social, index) => (
          <Grid item xs={1} justifyContent={'center'} alignItems={'center'} display={'flex'} key={social.alt}>
            <a href={social.url}>
